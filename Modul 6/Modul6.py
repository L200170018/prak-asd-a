...
mh1 = mahasiswa("Udin", 104, "AAAA", 10000)
mh2 = mahasiswa("Burhan", 84, "BBB", 13000)
mh3 = mahasiswa("Joni", 124, "CCC", 5000)
mh4 = mahasiswa("Dimas", 544, "DDDD", 12000)
mh5 = mahasiswa("Hago", 4, "EEE", 2000)
